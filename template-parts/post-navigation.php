...
if ($previous_post) {
    $previous_thumbnail = get_the_post_thumbnail($previous_post->ID, 'medium', array('class' => 'card-img-top'));
...
if ($next_post) {
    $next_thumbnail = get_the_post_thumbnail($next_post->ID, 'medium', array('class' => 'card-img-top'));
    ...
    ?>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php previous_post_link('%link', 'Learn more'); ?>
            </div>
        </div>
    <?php
    }
