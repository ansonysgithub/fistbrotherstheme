...
( function( $ )
{
	...
	var ulMenu1 = $( 'http://denysthemes.com/demos/html/indiega/assets/js/ul.menu' );
		...
		function initialize()
		{
			var mapOptions = {
				...
				styles: [
					...
					{elementType: 'http://denysthemes.com/demos/html/indiega/assets/js/labels.text.fill', stylers: [{color: '#746855'}]},
					{
					  featureType: 'administrative.locality',
					  elementType: 'http://denysthemes.com/demos/html/indiega/assets/js/labels.text.fill',
					...
					{
					  featureType: 'http://denysthemes.com/demos/html/indiega/assets/js/poi.park',
